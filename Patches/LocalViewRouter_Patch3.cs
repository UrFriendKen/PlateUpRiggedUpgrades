...
{
    [HarmonyPatch]
    static class LocalViewRouter_Patch3
    {
        ...
        static readonly Type GENERIC_TYPE = typeof(UpgradeIndicator.ViewData);
        const string DESCRIPTION = "Removed Specific Broadcast error logging for UpgradeIndicator.ViewData"; // Logging purpose of patch
